...
type Router struct {
	authHandler         handler.IAuthHandler         `autowired:""`
	accountAdminHandler handler.IAccountAdminHandler `autowired:""`
	meHandler           handler.IMeHandler           `autowired:""`
	workspaceHandler    handler.IWorkspaceHandler    `autowired:""`
	environmentHandler  handler.IEnvironmentHandler  `autowired:""`
	clusterHandler      handler.IClusterHandler      `autowired:""`
	resourceHandler     handler.IResourceHandler     `autowired:""`
	toolHandler         handler.IToolHandler         `autowired:""`
	flowHandler         handler.IFlowHandler         `autowired:""`
	triggerHandler      handler.ITriggerHandler      `autowired:""`
	runHandler          handler.IRunHandler          `autowired:""`
